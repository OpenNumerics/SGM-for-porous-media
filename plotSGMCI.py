...
lower_ci_c = pt.quantile(c_sgm, 0.025, dim=0) + 1.1*c_mean_diff
upper_ci_c = pt.quantile(c_sgm, 0.975, dim=0) + 1.1*c_mean_diff
lower_ci_phi = pt.quantile(phi_sgm, 0.025, dim=0) + 1.1*phi_mean_diff
upper_ci_phi = pt.quantile(phi_sgm, 0.975, dim=0) + 1.1*phi_mean_diff
...
ax1.plot(1e6 * x_cells, mean_c_sgm.flatten() + 1.1*c_mean_diff.flatten(), label='Mean SGM', color='red', linewidth=2)
...
ax2.plot(1e6 * x_cells, mean_phi_sgm.flatten()+ 1.1*phi_mean_diff.flatten(), label='Mean SGM', color='red', linewidth=2)
